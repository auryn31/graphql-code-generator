...
export const validate: PluginValidateFn<any> = async (_schema: GraphQLSchema, _documents: Types.DocumentFile[], _config: RawClientSideBasePluginConfig, outputFile: string) => {
